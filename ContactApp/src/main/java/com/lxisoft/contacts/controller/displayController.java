...
//		 contacts=repo.getAllContacts();
		ArrayList<Contact> contacts=(ArrayList<Contact>) serv.getAllContacts();
...
//			ModelAndView mv=new ModelAndView();
	        ...
	        response.setContentType("text/html; charset=utf-8");
	    		...
	    		switch(type)
	    		{
//	    		case "first" : serv.sortContactByFname();break;  jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj
